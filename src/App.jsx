...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* Main Card */}
      <div className="relative z-10 bg-white bg-opacity-90 backdrop-blur-md p-10 rounded-2xl shadow-xl w-full max-w-4xl">
        <h1 className="text-4xl font-bold text-center mb-6 text-gray-800">Airbnb Price Predictor</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-700">Number of Bedrooms</label>
            <input
              type="number"
              value={bedrooms}
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-700">Number of Bathrooms</label>
            <input
              type="number"
              value={bathrooms}
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-700">Location Score (1–10)</label>
            <input
              type="number"
              value={locationScore}
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-5 h-5"
            />
            <label className="text-gray-700">Has Parking</label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-5 h-5"
            />
            <label className="text-gray-700">Has WiFi</label>
          </div>
        </div>
